...
public class CommandHandler {
	...
	private HashMap<String, cmsc420_s22.QuakeHeap<Integer, String>.Locator> locators; // locators
	...
	void initialize(int nLevels) {
		heap = new cmsc420_s22.QuakeHeap<Integer, String>(nLevels); // initialize the heap
		locators = new HashMap<String, cmsc420_s22.QuakeHeap<Integer, String>.Locator>(); // initialize locators
		initialized = true;
	}
	...
	public String processCommand(String inputLine) throws Exception {
		...
		try {
			...
			// -----------------------------------------------------
				...
				cmsc420_s22.QuakeHeap<Integer, String>.Locator loc = locators.get(label); // get this entry's locator
				if (loc != null) {
			...
			// -----------------------------------------------------
				...
				output += "get-min-key: " + (key == null ? "null" : key) + System.lineSeparator();
			}
			// -----------------------------------------------------
			// GET-MAX-LEVEL
